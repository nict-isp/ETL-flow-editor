...
import DynamicFlink.s1POJO1449715999717;
...
public class GenericFilter1449715999717 implements FilterFunction<s1POJO1449715999717> {
...
public GenericFilter1449715999717(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1449715999717 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1449715999717 obj) {
    try{
