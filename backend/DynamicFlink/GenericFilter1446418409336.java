...
import DynamicFlink.s1POJO1446418409336;
...
public class GenericFilter1446418409336 implements FilterFunction<s1POJO1446418409336> {
...
public GenericFilter1446418409336(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1446418409336 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1446418409336 obj) {
    try{
