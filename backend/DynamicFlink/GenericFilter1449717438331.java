...
import DynamicFlink.s1POJO1449717438331;
...
public class GenericFilter1449717438331 implements FilterFunction<s1POJO1449717438331> {
...
public GenericFilter1449717438331(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1449717438331 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1449717438331 obj) {
    try{
