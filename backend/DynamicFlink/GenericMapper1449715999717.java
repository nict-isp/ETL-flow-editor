...
public class GenericMapper1449715999717 implements MapFunction<s1POJO1449715999717, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1449715999717(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1449715999717 obj) throws Exception {
        count+=1;
