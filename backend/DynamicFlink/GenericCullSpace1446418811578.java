...
public class GenericCullSpace1446418811578 implements FlatMapFunction<s1POJO1446418811578,s1POJO1446418811578> {
    ...
    public GenericCullSpace1446418811578(int p_num, int p_den, String lat_dn, String lon_dn, Double lat_in, Double long_in, Double p_north, Double p_south, Double p_east, Double p_west){
...
this.east = east;
    ...
    @Override    public void flatMap(s1POJO1446418811578 obj, Collector<s1POJO1446418811578> coll){
        double latitude;
        double longitude;
        try{
