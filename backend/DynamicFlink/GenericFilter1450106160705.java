...
import DynamicFlink.s4POJO1450106160705;
...
public class GenericFilter1450106160705 implements FilterFunction<s4POJO1450106160705> {
...
public GenericFilter1450106160705(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s4POJO1450106160705 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s4POJO1450106160705 obj) {
    try{
