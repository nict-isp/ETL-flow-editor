...
import DynamicFlink.s1POJO1449717548293;
...
public class GenericFilter1449717548293 implements FilterFunction<s1POJO1449717548293> {
...
public GenericFilter1449717548293(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1449717548293 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1449717548293 obj) {
    try{
