...
import DynamicFlink.s1POJO1446417802709;
...
public class GenericFilter1446417802709 implements FilterFunction<s1POJO1446417802709> {
...
public GenericFilter1446417802709(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1446417802709 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1446417802709 obj) {
    try{
