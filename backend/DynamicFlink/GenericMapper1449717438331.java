...
public class GenericMapper1449717438331 implements MapFunction<s1POJO1449717438331, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1449717438331(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1449717438331 obj) throws Exception {
        count+=1;
