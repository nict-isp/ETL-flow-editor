...
public class GenericMapper1449717548293 implements MapFunction<s1POJO1449717548293, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1449717548293(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1449717548293 obj) throws Exception {
        count+=1;
