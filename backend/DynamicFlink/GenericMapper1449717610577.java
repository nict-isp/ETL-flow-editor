...
public class GenericMapper1449717610577 implements MapFunction<s1POJO1449717610577, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1449717610577(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1449717610577 obj) throws Exception {
        count+=1;
