...
import DynamicFlink.s1POJO1449716370354;
import org.apache.flink.api.common.functions.MapFunction;
import com.WebSocket.EchoWebSocketEndPoint;
import com.google.gson.JsonObject;
public class GenericMapper1449716370354 implements MapFunction<s1POJO1449716370354, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1449716370354(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1449716370354 obj) throws Exception {
        count+=1;
