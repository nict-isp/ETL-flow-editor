...
public class GenericMapper1446418961617 implements MapFunction<s1POJO1446418961617, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1446418961617(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1446418961617 obj) throws Exception {
        count+=1;
