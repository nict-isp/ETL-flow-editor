...
import DynamicFlink.s1POJO1450106160705;
...
public class GenericCullTime1450106160705 implements FlatMapFunction<s1POJO1450106160705,s1POJO1450106160705> {
    ...
    public GenericCullTime1450106160705(int num, int den, String time_data_name, String start_time, String end_time, int interv, String time_unit){
        numerator = num;
        denominator = den;
    ...
    @Override
    public void flatMap(s1POJO1450106160705 obj, Collector<s1POJO1450106160705> coll){
