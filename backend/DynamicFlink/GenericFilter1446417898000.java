...
import DynamicFlink.s1POJO1446417898000;
...
public class GenericFilter1446417898000 implements FilterFunction<s1POJO1446417898000> {
...
public GenericFilter1446417898000(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1446417898000 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1446417898000 obj) {
    try{
