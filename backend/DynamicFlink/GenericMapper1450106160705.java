...
public class GenericMapper1450106160705 implements MapFunction<s1POJO1450106160705, String> {
    private String sourceID;
    private static long startTime;
    private static long endTime;
    private long ds_size;
    private long count;
    public GenericMapper1450106160705(String source_id, long size){
        sourceID = source_id;
    ...
    @Override
    public String map(s1POJO1450106160705 obj) throws Exception {
        count+=1;
