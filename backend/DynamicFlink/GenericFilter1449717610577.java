...
import DynamicFlink.s1POJO1449717610577;
...
public class GenericFilter1449717610577 implements FilterFunction<s1POJO1449717610577> {
...
public GenericFilter1449717610577(ArrayList<JsonObject> p_conditions, String p_logicOP){
	conditions = p_conditions;
	logicOP = p_logicOP;
}
private String composeFilterConditions(s1POJO1449717610577 obj) throws NoSuchFieldException, SecurityException{
	String field;
	String value = null;
	String value1 = null;
	String value2 = null;
...
@Override
public boolean filter(s1POJO1449717610577 obj) {
    try{
