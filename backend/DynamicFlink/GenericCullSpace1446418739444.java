...
import DynamicFlink.s1POJO1446418739444;
import org.apache.flink.api.common.functions.FlatMapFunction;
import org.apache.flink.util.Collector;
public class GenericCullSpace1446418739444 implements FlatMapFunction<s1POJO1446418739444,s1POJO1446418739444> {
    ...
    public GenericCullSpace1446418739444(int p_num, int p_den, String lat_dn, String lon_dn, Double lat_in, Double long_in, Double p_north, Double p_south, Double p_east, Double p_west){
...
this.east = east;
    ...
    @Override    public void flatMap(s1POJO1446418739444 obj, Collector<s1POJO1446418739444> coll){
        double latitude;
        double longitude;
        try{
