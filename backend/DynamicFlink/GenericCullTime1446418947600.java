...
public class GenericCullTime1446418947600 implements FlatMapFunction<s1POJO1446418947600,s1POJO1446418947600> {
    ...
    public GenericCullTime1446418947600(int num, int den, String time_data_name, String start_time, String end_time, int interv, String time_unit){
        numerator = num;
        denominator = den;
    ...
    @Override
    public void flatMap(s1POJO1446418947600 obj, Collector<s1POJO1446418947600> coll){
